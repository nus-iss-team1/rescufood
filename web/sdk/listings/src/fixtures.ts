...
export const sampleRequests: ListingRequest[] = [
  ...
  request({
    ...
    respondedBy: donor,
    respondedAt: "2026-08-11T04:00:00.000Z",
    codeExpiresAt: "2026-08-12T11:30:00.000Z",
    codeGeneratedBy: donor,
  }),
  request({
    ...
    status: "declined",
    declineReason: "Already promised to another partner",
    respondedBy: donor,
  ...
  request({
    ...
    verifiedBy: rescue,
    respondedBy: donor,
    respondedAt: "2026-08-09T18:00:00.000Z",
